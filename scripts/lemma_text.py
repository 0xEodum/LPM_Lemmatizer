...
def main() -> int:
    ...
    parser.add_argument("--language", "-l", help="Language code: de, es, fi, fr, ar, hy/am, it, jp/ja, kr/ko, pt, tr, vi.")
...
def _interactive(language: str | None, as_json: bool) -> int:
    ...
    if not current_language:
        current_language = input("Language (de/es/fi/fr/ar/hy/it/jp/kr/pt/tr/vi): ").strip()
    if not current_language:
